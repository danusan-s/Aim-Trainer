...
class ResourceManager {
   public:
    ...
    // loads (and generates) a shader program from file loading vertex, fragment (and geometry) shader's source code. If
    // gShaderFile is not nullptr, it also loads a geometry shader
